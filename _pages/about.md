...
1. **μShare: Non-Intrusive Kernel Co-Locating on NVIDIA GPUs**  
   ...
   *Conference:* HPCA 2026.  
   [[paper]()][[code]()]
2. **iRoute: Local Routing Table-based Workflow Management in Serverless Computing**  
   *Authors:*  Yiming Li, Laiping Zhao, Zhiyuan Su, Guowei Liu, Wenhao Huang, Kang Chen, **Zhaolin Duan**, Jingjie Zong, Wenxin Li, Deze Zeng, Dong Zhang, Wenyu Qu.<br>
   *Conference:* EuroSys 2026.  
   [[paper]()][[code]()]
3. **FUYAO: DPU-enabled Direct Data Transfer for Serverless Computing**  
...
4. **Photia: Cross-Layer Cache Optimization for Function Startup in Serverless Computing**  
   *Authors:*  **Zhaolin Duan**, Yanan Yang, Laiping Zhao.<br>
   *Conference:* HPCC 2024.  
5. **Strong Session Serializability for Serverless Computing**  
