...
3. **iRoute: Local Routing Table-based Workflow Management in Serverless Computing**  
   ...
   *Conference:* EuroSys 2026.  
   [[paper]()][[code]()]
3. **Photia: Cross-Layer Cache Optimization for Function Startup in Serverless Computing**  
   *Authors:*  **Zhaolin Duan**, Yanan Yang, Laiping Zhao.<br>
   *Conference:* HPCC 2024.  
4. **Strong Session Serializability for Serverless Computing**  
